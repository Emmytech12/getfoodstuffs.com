...
<link href="<?php echo $website_url?>/admin/style/dashboard-style.css?v=<?php echo $code_version?>" type="text/css" rel="stylesheet" />
<link href="<?php echo $website_url?>/admin/style/jquery.datetimepicker.css" type="text/css"rel="stylesheet"/>
...
<script src="<?php echo $website_url?>/admin/js/jquery.datetimepicker.js"></script>
<script src="<?php echo $website_url?>/admin/js/chart.min.js"></script>
<script src="<?php echo $website_url?>/admin/js/canvasjs.min.js" type="text/javascript"></script>
